...
export default function AudioPlayerPage() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 max-w-5xl mx-auto py-4">
      <PageHeader
        badge="Purely Local Playback"
        title="Local Audio Player"
        description="Focused, lightweight local audio player. Zero cloud telemetry, instant IndexedDB queue, and real-time frequency visualizer."
      />
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          <Card variant="glass" className="p-8 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-full bg-gradient-to-tr from-neutral-900 via-neutral-800 to-neutral-700 shadow-2xl border-4 border-neutral-800/80 flex items-center justify-center mb-6">
              <div
            ...
            {/* Track Info */}
            <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-50 mb-1 max-w-sm truncate">
            ...
            <div className="flex items-center justify-center gap-4 sm:gap-6 mb-6">
              <button
                ...
                className={`p-2 rounded-full transition-colors ${
                  isShuffle ? "text-apple-blue" : "text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200"
                }`}
              >
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      <div
                        className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${
                          isSelected ? "bg-apple-blue text-white" : "bg-neutral-100 dark:bg-neutral-800 text-neutral-400"
                        }`}
                      >
                        {isItemPlaying ? (
