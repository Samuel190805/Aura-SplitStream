...
function MashupCreatorContent() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 max-w-5xl mx-auto py-4">
      <PageHeader
        badge="AI Harmonic Remix Engine"
        title="Two songs. One harmonic blend."
        description="Blend vocals, basslines, and beats across any two tracks with automatic Camelot key matching, phase beat synchronization, and -14 LUFS mastering."
      />
      ...
      {!isProcessing && !isCompleted && (
        <Card variant="glass" className="w-full p-8 shadow-apple dark:shadow-apple-dark">
          <form onSubmit={handleStartMashup} className="flex flex-col gap-8">
                        ...
                        <button
                          ...
                          className={`p-2.5 rounded-xl border text-xs font-semibold flex items-center justify-between transition-all ${
                            isChecked
                              ...
                              : "bg-white/60 dark:bg-white/5 border-neutral-200/60 dark:border-white/10 text-neutral-600 dark:text-neutral-300"
                          }`}
                        >
            ...
            <div className="p-5 rounded-2xl bg-neutral-100/70 dark:bg-white/5 border border-neutral-200/60 dark:border-white/10 flex flex-col gap-4">
              ...
              {/* Toggles & Format */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-3 border-t border-neutral-200/60 dark:border-white/5">
            ...
            >
              <Layers className="w-4 h-4" /> Render AI Mashup Now
            </Button>
          </form>
        </Card>
      )}
      ...
      {isCompleted && completedAsset && (
        <Card variant="glass" className="w-full p-8 flex flex-col gap-6 animate-in fade-in shadow-apple">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                download
                className="px-3 py-1.5 rounded-xl bg-apple-blue text-white text-xs font-semibold flex items-center gap-1.5 shadow-sm hover:bg-apple-blue/90"
              >
          ...
          {/* Transport Bar */}
          <div className="flex items-center justify-center gap-4 pt-2 border-t border-neutral-200/60 dark:border-white/10">
            <Button
              variant="primary"
              onClick={() => {
              ...
              className="w-12 h-12 rounded-2xl flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 shadow-sm"
            >
              {isPlaying ? (
